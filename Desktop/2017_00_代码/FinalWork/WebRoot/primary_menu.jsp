<%@page import="ouc.sms.entity.Employees"%>
...
<!-- Placed js at the end of the document so the pages load faster -->
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
 	<% Object msg=request.getAttribute("msg"); 
  	   Object empNo=request.getAttribute("empNo");
  	   Object eprvl=request.getAttribute("eprvl");
			...
			<div class="left-side-inner">
				...
				<!--sidebar nav start-->
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li class="active"><a href="index.html"><i class="lnr lnr-power-switch"></i><span></span></a></li>
						<li class="menu-list">
						...
						<li><a href="forms.html"><i class="lnr lnr-spell-check"></i> <span>安全目标</span></a></li>
						<li><a href="tables.html"><i class="lnr lnr-menu"></i> <span>安全教育­</span></a></li>              
						<li class="menu-list"><a href="#"><i class="lnr lnr-envelope"></i> <span>组织机构与指责</span></a>
							<ul class="sub-menu-list">
								<li><a href="inbox.html">Inbox</a> </li>
								<li><a href="compose-mail.html">Compose Mail</a></li>
							</ul>
						</li>      
						<li class="menu-list"><a href="#"><i class="lnr lnr-indent-increase"></i> <span>文件管理</span></a>  
							<ul class="sub-menu-list">
								<li><a href="charts.html">Basic Charts</a> </li>
							</ul>
						</li>
						<li><a href="codes.html"><i class="lnr lnr-pencil"></i> <span>突然事件响应</span></a></li>
						<li><a href="media.html"><i class="lnr lnr-select"></i> <span>安全检测与评估</span></a></li>
						<li class="menu-list"><a href="#"><i class="lnr lnr-book"></i>  <span>风险管理</span></a> 
							<ul class="sub-menu-list">
							<li>
								         <a href="/FinalWork/privilegeSelectionServlet?empNo=<%=empNo%>&eprvl=<%=eprvl%>"><li>安全信息管理</li></a>
								         </li>
								<li><a href="blank_page.html">负责人公约</a></li>
								<li><a href="#" target="_bland">今日头条</a></li>
      							<li> <a href="#" target="_bland">年度报表</a></li>
       							<li><a href="#" target="_bland">奖惩制度</a></li>
       							 <li><a href="/FinalWork/primary_menu.jsp">返回首页</a> <li> 
								<li><a href="/FinalWork/login_emp.jsp">推出系统</a><li>
							</ul>
						</li>
					</ul>
				<!--sidebar nav end-->
