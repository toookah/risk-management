				...
				<div class="v-center" style="text—align:center">
					<div class="row" style="text—align:center">
						<div class="col-xs-10 col-sm-6" style="text—align:center">
							<h1 class="mb-10 heading" aligh="center">Welcome<span></span></h1>
							<br>
							<br>
							<div class="subheading mb-20"><br class=hidden-xs> </div>
						</div>
					</div>
					<div>
						...
						<a class="btn btn-prepend" href="/FinalWork/show_fead_back.jsp?empNo=<%=empNo%>">
							...
							<a class="btn btn-prepend" href="/FinalWork/failProServlet">
							<i class="prepended icon-append-iphone"></i>我的复查单<br>	
</a>
							<a class="btn btn-prepend" href="/FinalWork/waitProServlet">
							<i class="prepended icon-append-iphone"></i>待办检查单	
							</a>
							<a class="btn btn-prepend" href="/FinalWork/mng_dealt_pro.jsp">
							<i class="prepended icon-append-iphone"></i>已办检查单
							</a>
							<a class="btn btn-prepend" href="/FinalWork/mng_pass_pro.jsp">
