...
//       int mngno=Integer.parseInt(String.valueOf(obj));
   ...
   <form action="auditProServlet" method = "post">
   <% 
   ...
   <tr>
	...
	<tr>
		...
		<td><textarea name="describe" style="width:200px;height:80px;" readonly="readonly"><%=pro.getProDesc()%></textarea></td>
	</tr>
	<tr>
		<td width="30%" align="right">项目措施</td>
		
		<td ><textarea name="method" style="width:200px;height:80px;" readonly="readonly"><%=pro.getProMethod()%></textarea></td>

	</tr>
	<tr>
		<td align="right">项目评分</td>
		<td><input type="text" name="score" size="10"/>当前风险值</td>
	</tr>
	<tr>
		<td align="right">项目要求</td>
		<td><textarea name="demmand" style="width:200px;height:80px;" >监管部门填写</textarea></td>

	</tr>	
	<tr>
		<td align="right"></td>	
		<td><input type="submit" name="submit" value="fail"/> <input type="submit" name="submit" value="pass"/></td>
