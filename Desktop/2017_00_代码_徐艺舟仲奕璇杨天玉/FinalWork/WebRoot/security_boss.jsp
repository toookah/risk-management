				...
				<div class="v-center" style="text—align:center">
					...
					<div>
						...
						<a class="btn btn-prepend" href="/FinalWork/show_fead_back.jsp?empNo=<%=empNo %>">
							...
							<a class="btn btn-prepend" href="/FinalWork/bos_show_all_pro.jsp?choice=1">
							<i class="prepended icon-append-iphone"></i>待办检查单<br>	
							</a>
							<a class="btn btn-prepend" href="/FinalWork/bos_show_all_pro.jsp?choice=2">
							<i class="prepended icon-append-iphone"></i>待监检查单	
							</a>
							<a class="btn btn-prepend" href="/FinalWork/bos_show_all_pro.jsp?choice=4">
							<i class="prepended icon-append-iphone"></i>复查单	
							</a>
							<a class="btn btn-prepend" href="/FinalWork/bos_show_all_pro.jsp?choice=3">
